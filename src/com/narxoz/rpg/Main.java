...
public class Main {
    public static void main(String[] args) {
        ...
        ArenaFighter hero = new ArenaFighter("Kabanbay Batyr", 100, 0.20, 25, 5, 18, 3);
        ArenaOpponent opponent = new ArenaOpponent("Jungar Champion", 90, 14);
        ...
        System.out.println("Hero HP before attack: " + hero.getHealth());

        // attack 20 hp
        dodge.handle(20, hero);

        System.out.println("Hero HP after attack:  " + hero.getHealth());
